...
# Set up system paths for custom imports
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../shopee-omzet-automation'))) # Path to root core
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../..'))) # Path to VB directory
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../'))) # Path to database manager

from VB.core.browser import load_session, validate_session
from VB.core.client import ShopeeClient
from VB.core.logger import get_logger
